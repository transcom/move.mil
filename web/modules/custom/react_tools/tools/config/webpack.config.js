...
function getConfig(webpackEnv, appName) {
  return new Promise((resolve, reject) => {
    apps.getDirectories()
      .then((appDirList) => {
        ...
        const appPaths = isEnvProduction ? apps.appPaths(null, appDirList) : apps.appPaths(appName);
        ...
        resolve(
          ...
          config: {
            ...
            optimization: {
              ...
              // TODO: Removed for prod build - js
              // splitChunks: {
              //   chunks: 'all',
              //   name: false,
              // },
            ...
            plugins: [
              ...
              isEnvProduction &&
                new MiniCssExtractPlugin({
                  ...
                  chunkFilename: 'static/css/[name].min.css',
                }),
              ...
              useTypeScript &&
                new ForkTsCheckerWebpackPlugin({
                  ...
                  watch: isEnvDevelopment ? appPaths.appSrc : _.map(appPaths, _paths => _paths.appSrc),
                  silent: true,
